...
public class PSWAMModel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Constrained Hill-Climbing Algorithm");

        jButton1.setText("Partially Supervised Candidate Extraction");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        WordAlignment wa=new WordAlignment();
        wa.setResizable(false);
        wa.setTitle("Word Alignment");
        wa.setVisible(true);
        
        /*GraphBasedCoRanking gc=new GraphBasedCoRanking();
        gc.setResizable(false);
        gc.setTitle("GraphBased CoRanking");
        gc.setVisible(true);*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PSWAMModel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
